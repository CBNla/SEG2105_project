...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createEmployeeTable = "create table Employee(" + "userName varchar(50)," + "password varchar(50)," + "name varchar(50)," + "address varchar(50)," + "phoneNum int," + "nameOfClinic varchar(50)," + "insuranceTypes varchar(50)," + "paymentMethod varchar(50)," + "workingHour varchar(10000)," + "primary key(UserName))";
